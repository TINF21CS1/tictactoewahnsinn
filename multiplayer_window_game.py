...
class Window():
    def __init__(self):
        ...
        # Statistik-Objekt
        self.stats_canvas = Canvas(self.window, width=300, height=board_size/2, bg='lightgray')
        self.stats_canvas.grid(row=0, column=0, sticky=N+S+E+W, padx=20, pady=20)

        # Leave-Objekt
        self.leave_canvas = Canvas(self.window, width=50, height=50, bg='lightgray')
        self.leave_canvas.grid(row=1, column=0, sticky=N+S+E+W, padx=20, pady=20)

        # Board-Objekt
        self.board_canvas = Canvas(self.window, width=board_size, height=board_size)
        self.board_canvas.grid(row=0, column=1, sticky=N+S+E+W)

        # Chat-Objekt
        self.chat_canvas = Canvas(self.window, width=300, height=board_size, bg='lightgray')
        self.chat_canvas.grid(row=0, column=2, sticky=N+S+E+W, padx=20, pady=20)
        ...
        min_height = self.stats_canvas.winfo_reqheight() + self.leave_canvas.winfo_reqheight() + 10  # 10 Pixel Platz oben und unten
